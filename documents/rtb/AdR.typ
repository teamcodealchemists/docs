...
- Il Team di Verificatori, che lo adotterà come base per la definizione dei casi di test e la verifica del corretto funzionamento del prodotto#super[G].
...
Sarà adottata *un'architettura scalabile a microservizi#super[G]*, che garantisca alta disponibilità, interoperabilità tra i nodi della rete, e gestione efficiente del carico, anche in presenza di numerose richieste simultanee. Ogni nodo#super[G] della rete – cioè ciascun magazzino – potrà operare in modo autonomo, mantenendo però sincronizzazione con un sistema centrale tramite servizi#super[G] cloud.
...
L'obiettivo finale è realizzare una *piattaforma robusta e flessibile* che migliori la resilienza e l'efficienza dell'intera rete logistica, assicurando precisione, tempestività e scalabilità nelle operazioni di gestione dell'inventario#super[G].
...
- *Microservizi#super[G]:* come richiesto dal capitolato#super[G], il sistema dovrà essere progettato utilizzando un'architettura a microservizi#super[G], che consente di suddividere il sistema in componenti più piccoli e indipendenti, facilitando la scalabilità e la manutenibilità del sistema.\
...
- *Architettura Event-Driven:* l'architettura del sistema dovrebbe essere basata su eventi, in modo da garantire una comunicazione efficiente tra i microservizi#super[G] e una gestione ottimale delle risorse.\
  In questo modo, ogni microservizio può reagire a eventi specifici e comunicare con gli altri microservizi#super[G] in modo asincrono, migliorando le prestazioni e la reattività del sistema.\
...
#table(
  ...
  [*RF04/03*], [Il sistema deve proporre trasferimenti per bilanciare le scorte#super[G] e migliorare l'efficienza], [capitolato#super[G]],
  ...
  [*RF08*], [*Visibilità centrale in tempo reale di tutte le scorte#super[G] distribuite (monitoraggio livelli inventario#super[G]), di ogni magazzino (anche indipendentemente), permettendo il trasferimento#super[G] di prodotti, il riassortimento#super[G], e la riduzione dei livelli medi di scorte#super[G] mantenendo però livelli di sicurezza in caso di carenze o ritardi*], [capitolato#super[G]],
  ...
  [*RF09*], [*Permettere il trasferimento#super[G] di prodotti*], [capitolato#super[G]],
  [*RF09/01*], [Il sistema deve consentire la creazione di ordini#super[G] di trasferimento#super[G]], [capitolato#super[G]],
  [*RF09/02*], [Il sistema deve tracciare il trasferimento#super[G] dei prodotti], [capitolato#super[G]],
  ...
  [*RF12/01*], [È necessario fornire raccomandazioni per il riassortimento#super[G] e i trasferimenti], [capitolato#super[G]],
  ...
  [*RFO02*], [*Implementazione di meccanismi di autorizzazione e autenticazione#super[G], inclusa la gestione di ruoli e permessi differenziati per operatori, supervisori e amministratori*], [capitolato#super[G]],
...
//Requisiti#super[G] di Sicurezza opzionali
  ...
  [*RSO03*], [*Assicurare che l'autenticazione#super[G] sia robusta tramite MFA e certificati crittografici*], [capitolato#super[G]],
