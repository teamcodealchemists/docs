...
#let voci_registro = (
  ...
  /*[3.0.0], [15/04/2025], [_M31_], [-], [Approvazione del documento da parte di _M31_], 
  [2.0.0], [14/04/2025], [-], [R. Zangla], [Approvazione interna del documento],
  */
  [1.1.0], [14/04/2025], [N. Moretto \ N. Bolzon], [R. Zangla], [Modifica del documento],
...
+ *Q: Vengono proposte due tecnologie diverse per l'archiviazione dei dati (_MongoDB_ e _PostgreSQL_) a seconda se si tratta di dati aggregati o meno. Il motivo di questa distinzione?* \
  *A:* Lo stack proposto corrisponde a quello utilizzato in azienda. È possibile discostarsi da tali tecnologie in base all’architettura adottata, a condizione di motivare in modo non banale la scelta. È da notare come sia insolito trovare in un capitolato#super("G") un comparto tecnico così dettagliato. \
