...
#let voci_registro = (
  ...
  [2.0.0], [--/05/2025], [_M31_], [-], [Approvazione del documento da parte di _M31_], 
  [1.0.0], [--/05/2025], [-], [-], [Approvazione interna del documento],
  [0.2.0], [--/05/2025], [-], [-], [Aggiunta di informazioni al documento e correzione di errori sintattici e grammaticali],
  [0.1.0], [06/05/2025], [N. Moretto], [-], [Redazione iniziale del documento]
...
L'azienda ha infatti espresso la volontà di effettuare gli incontri in presenza presso la loro sede.
...
- Per quanto riguarda la copia di tutti i magazzini su cloud, ci è stato chiesto il motivo di questa scelta e inizialmente è stata espressa molta perplessità al riguardo, in quanto secondo loro sarebbe più opportuno e meno dispendioso avere uno stato aggregato dei magazzini, piuttosto che una copia di tutti i magazzini.\ Noi abbiamo spiegato che l'idea è dovuta al fatto che la copia è in sola lettura ed è utile per ridurre la latenza delle operazioni di lettura, e per eventuali operazioni di scrittura provenienti dal sistema centralizzato è previsto un sistema di messaging che si occupa di inviare richieste di scrittura ai vari magazzini locali.\ Dopo questa spiegazione, l'azienda ha accettato questa scelta progettuale, ma ha comunque suggerito di riflettere su questa decisione e di considerare l'idea di avere un sistema centralizzato con un unico database contenente lo stato aggregato dei magazzini.\
...
Per eventuali necessità, l'azienda ha rinnovato la sua disponibilità tramite i consueti canali di contatto.\ L'azienda ci invita a contattarli per qualsiasi dubbio, soprattutto relativo alle richieste funzionali. Pur non essendo obbligati a supportarci sul piano tecnico, lo faranno volentieri dove possibile.\
...
Il _Team Code Alchemists_ desidera infine ringraziare l'azienda _M31_ la consueta professionalità e disponibilità dimostrate nel supportarci durante lo sviluppo del progetto.
